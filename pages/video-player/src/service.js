...
export default class Service {
  ...
  // ref https://github.com/monaca-samples/blink-to-text/blob/f3d578ff641298913833b04e98e854bf1cfe38e1/src/js/blinkPrediction.js#L18-L34
  #getEAR(upper, lower) {
  ...
  async handBlinked(video) {
    ...
    // ref https://github.com/monaca-samples/blink-to-text/blob/f3d578ff641298913833b04e98e854bf1cfe38e1/src/js/blinkPrediction.js#L42-L71
    for (const prediction of predictions) {
      ...
      const rightEyeBlinked = rightEAR <= EAR_THRESHOLD;
      const leftEyeBlinked = leftEAR <= EAR_THRESHOLD;
      const blinked = rightEyeBlinked || leftEyeBlinked;
